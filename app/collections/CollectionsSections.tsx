        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 relative">
          ...
          <div ref={contentRef} className="lg:col-span-3 section-content">
              ...
              <div className="mb-8">
                ...
                <div className="mb-8">
                  <h3 className="font-bold mb-4">Personnel</h3>
            <p className="mb-4">
              In 2002, <ExternalLink href="https://www.amnh.org/research/staff-directory/lorenzo-prendini">Lorenzo Prendini</ExternalLink> was hired to curate the Arachnid (non-spider) and Myriapod Collections in the <ExternalLink href="https://research.amnh.org/invertzoo">Division of Invertebrate Zoology</ExternalLink> at the American Museum of Natural History. The following arachnid orders fall under his jurisdiction: Acari (mites and ticks), Amblypygi (whip spiders), Opiliones (harvestmen), Palpigradi (palpigrades), Pseudoscorpiones (false scorpions), Schizomida (schizomids), Scorpiones (scorpions), Solifugae (solifuges, solpugids or camel-spiders), Uropygi (vinegaroons or whip scorpions).
            </p>
            <p className="mb-4">
          ...
          <div className="mb-8 border-t pt-8" id="use-of-collections">
            <h3 className="font-bold mb-4">Use of Collections</h3>
            <p className="mb-6">
              Incoming and outgoing loans of specimens from the Arachnid and Myriapod Collections are a weekly occurrence, while visits to the collections occur less frequently, averaging once a month. Queries regarding visits, loan requests, specimen donations, and the preservation of tissue samples for molecular analysis should be addressed to <ExternalLink href="https://www.amnh.org/research/staff-directory/lorenzo-prendini">Lorenzo Prendini</ExternalLink>. Anyone interested in the particular protocols used for the preservation and management of the AMNH Arachnid and Myriapod Collections should contact <a href="/people/staff" className="text-color-link hover:text-color-link-hover underline">Pio Colmenares</a>. Donors should refer to the Division of Invertebrate Zoology <ExternalLink href="https://www.amnh.org/research/invertebrate-zoology/policies/specimen-collecting-deposition">instructions for depositing material.</ExternalLink> Those interested in management of natural history collections should consult the website for the <ExternalLink href="http://www.spnhc.org">Society for the Preservation of Natural History Collections</ExternalLink> (SPNHC).
            </p>
          </div>

          <div className="mb-8 border-t pt-8" id="loan-requests">
            <h3 className="font-bold mb-4">Loan Requests</h3>
            <p className="mb-6">
              If you would like to apply for a loan, please complete the following form so we can consider your request: <ExternalLink href="https://forms.gle/JsH1bysFeFucUyJb6">AMNH Arachnida and Myriapoda Loan Request Form</ExternalLink>
            </p>
          </div>

          <div className="mb-8 border-t pt-8" id="visiting-scientists">
            <h3 className="font-bold mb-4">Visiting Scientists</h3>
            <p className="mb-4">
            ...
            <ul className="list-disc list-inside space-y-2 mb-6">
              <li><ExternalLink href="https://www.amnh.org/research/richard-gilder-graduate-school/grants#3-collection-study-grants">Collections Study Grants</ExternalLink></li>
              <li><ExternalLink href="https://www.amnh.org/research/richard-gilder-graduate-school/grants#1-theodore-roosevelt-memorial-grants">Theodore Roosevelt Memorial Fund</ExternalLink></li>
            </ul>
            <Image
          ...
          <div className="mb-8">
            ...
            <h3 className="font-bold mb-4" id="scorpions">Scorpions</h3>
            <p className="mb-4">
            ...
            <h3 className="font-bold mb-4" id="curation">Curation of Collections</h3>
            <p className="mb-6">
            ...
            <h3 className="font-bold mb-4" id="legal-documentation">Legal Documentation</h3>
            <div className="mb-6">
              <h4 className="font-bold mb-2">AMNH Specimen Transfer Form</h4>
              <p>
                All specimens and tissue samples collected by non-AMNH staff and deposited into the AMNH collections are considered 'donations'. Non-AMNH staff must provide a signed copy of the <ExternalLink href="https://research.amnh.org/users/lorenzo/PDF/AMNH_STF.pdf">specimen transfer form (PDF)</ExternalLink> with other legal documentation (if required) when donating specimens or samples. A completed, signed form must accompany each parcel of specimens received, not each specimen/lot.
              </p>
            </div>
            <div className="mb-6">
              <h4 className="font-bold mb-2">Specimens Collected in the US</h4>
              <p>
            ...
            <div className="mb-6">
              <h4 className="font-bold mb-2">Specimens Collected Beyond US Borders</h4>
              <p className="mb-4">
