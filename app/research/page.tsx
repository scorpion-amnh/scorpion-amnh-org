    ...
    <div className="bg-white min-h-screen">
      <div className="container mx-auto max-w-5xl px-6 py-12">
        <div className="mb-12">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Adaptational and Biogeographical Hypotheses</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Comparative Morphology and Anatomy</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Behavior</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Paleontology</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Theory and Practice of Systematics</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Insect-Plant Associations</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Funding</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
