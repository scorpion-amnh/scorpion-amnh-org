...
type LorenzoPrendiniProfileProps = {
  /** Heading tag used for the "Lorenzo Prendini" name. Pass `null` to omit it (e.g. when a page already has an <h1> with his name). */
  nameHeading?: "h1" | "h3" | null;
};

export function LorenzoPrendiniProfile({ nameHeading = "h3" }: LorenzoPrendiniProfileProps) {
  const NameTag = nameHeading ?? "h3";
  ...
  return (
    <div className="grid md:grid-cols-5 gap-6">
      ...
      <div className="md:col-span-3">
        {nameHeading ? <NameTag className="font-bold mb-2">Lorenzo Prendini</NameTag> : null}
