...
export const researchAffiliatesData: PeopleCategory = {
  current: [
    {
      id: "boris-zakharov",
      name: "Boris Zakharov",
...
export const postdocsData: PeopleCategory = {
  current: [
    {
      id: "muhammad-tahir",
...
export const graduateStudentsData: PeopleCategory = {
  current: [
    {
      id: "george-popovici",
  ...
  alumni: [
    ...
    },
    {
      id: "stephanie-f-loria",
      name: "Stephanie F. Loria",
      title: "Richard Gilder Graduate School, American Museum of Natural History",
      years: "Graduate student from 2011 to 2016",
      image: "Stephanie-F-Loria.jpg",
      bio: "Stephanie first came to the AMNH as a high school student participating in the High School Science Research Program of the Center for Biodiversity and Conservation with Felicity Arengo. In 2011, she completed her B.S. at Sewanee University in TN. During her B.S. she spent a summer working at the Field Museum of Natural History in Chicago as an NSF REU intern studying the evolution and biogeography of the Malagasy giant pill-millipedes, genus <em>Sphaeromimus</em>, under the guidance of Thomas Wesener and Petra Sierwald. Stephanie entered the Comparative Biology PhD program at the AMNH Richard Gilder Graduate School in 2011 and graduated in 2015. Her dissertation focused on the evolution and biogeography of Southeast Asian scorpions, particularly the family Chaerilidae."
    },
    {
...
export const undergraduateStudentsData: PeopleCategory = {
  current: [
    {
      id: "william-phillips",
  ...
  alumni: [
    ...
    },
    {
      id: "michelle-yun",
      name: "Michelle Yun",
      affiliation: "CUNY, York College",
      years: "Undergraduate student in 2010",
      image: null,
      bio: "Michelle took part in an investigation of the phylogeny of the scorpion genus <em>Parabuthus</em> sequencing six different loci from samples collected all over southern Africa."
    },
    {
      id: "angela-holuba",
      name: "Angela Holuba",
    ...
    {
      id: "lauren-a-esposito-undergrad",
      name: "Lauren A. Esposito",
...
export const highSchoolStudentsData: PeopleCategory = {
  current: [
    {
      id: "meredith-metz",
      name: "Meredith Metz",
  ...
  alumni: [
    ...
    },
    {
      id: "eleanor-goetz-hs",
      name: "Eleanor Goetz",
      years: "High school student from 2013 to 2014",
      image: "Sasha-Reiter--and--Eleanor-Goetz.jpg",
      bio: "Eleanor attended the AMNH Science Research Mentoring Program (SRMP) at the AMNH for the 2013-2014 academic year. She worked in the Molecular Systematics Laboratory where she learned to isolate, amplify, sequence, and edit DNA under the supervision of Stephanie Loria."
    },
    {
      id: "sasha-reiter",
      name: "Sasha Reiter",
      years: "High school student from 2013 to 2014",
      image: "Sasha-Reiter--and--Eleanor-Goetz.jpg",
      bio: "Sasha attended the AMNH Science Research Mentoring Program (SRMP) at the AMNH for the 2013-2014 academic year. They worked in the Molecular Systematics Laboratory where they learned to isolate, amplify, sequence, and edit DNA under the supervision of Stephanie Loria."
    },
    {
      id: "adam-getzler",
      name: "Adam Getzler",
...
export const volunteersData: PeopleCategory = {
  current: [
    {
      id: "soleil-blanquera",
...
export const visitorsData: PeopleCategory = {
  current: [
    {
      id: "antonio-galan-sanchez",
  ...
  alumni: [
    ...
    {
      id: "jairo-a-moreno-gonzalez-visitor",
      name: "Jairo A. Moreno-González",
    ...
    {
      id: "andria-de-paula-santos-da-silva",
    ...
    {
      id: "carlos-alberto-martinez-munoz",
    ...
    {
      id: "jesus-alberto-cruz-lopez",
      name: "Jesus Alberto Cruz-López",
      title: "Instituto de Biología, Universidad Nacional Autonóma de México (IBUNAM), Mexico City",
      years: "Student in 2017",
      image: "Jesus-Alberto-Cruz-Lopez.jpg",
      bio: "Jesus visited the AMNH to examine the collection of mexican harvestmen (Opiliones) as part of his dissertation research."
    },
    {
      id: "ricardo-botero-trujillo-visitor",
      name: "Ricardo Botero-Trujillo",
    ...
    {
      id: "francisco-salgueiro-sepulveda",
    ...
    {
      id: "bastian-jesper-klussmann-fricke",
    ...
    {
      id: "ingrid-catalina-romero-ortiz",
      name: "Ingrid Catalina Romero Ortiz",
      title: "Universidad Nacional de Colombia, Bogotá",
      years: "Graduate student in 2015",
      image: "Catalina-Romero.jpg",
      bio: "Ingrid Catalina visited the AMNH to study the pseudoscorpion holdings and types as part of her graduate research on their taxonomy and systematics."
    },
    {
      id: "daniela-ramirez",
      name: "Daniela Ramírez",
      title: "Instituto de Biología, Universidad Nacional Autonóma de México (IBUNAM), Mexico City",
      years: "PhD student in 2014",
      image: "DanielaRamirez.jpg",
      bio: "Daniela visited the AMNH to examine the collection of tarantula spiders (Theraphosidae) as part of her PhD research."
    },
    {
      id: "carlos-santibanez-lopez",
    ...
    {
      id: "jesus-alfonso-ballesteros-chavez",
    ...
    {
      id: "andres-ojanguren-affilastro",
