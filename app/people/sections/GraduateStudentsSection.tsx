    ...
    <div data-section="graduate-students" className={isActive ? 'block' : 'hidden'}>
        <div>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">George Popovici</h3>
              <p className="text-base mb-1">Comparative Biology Ph.D. Program, Richard Gilder Graduate School, AMNH</p>
              <p className="text-meta mb-3">Graduate student from 2026 - Ph.D. on systematics and biogeography of the Asian vinegaroons (whip scorpions) and the evolution of defense secretions</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Alice Wang</h3>
              <p className="text-base mb-1">Comparative Biology Ph.D. Program, Richard Gilder Graduate School, AMNH</p>
              <p className="text-meta mb-3">Graduate student from 2026 - Ph.D. on phylogeny and evolution of sound communication in hormurid scorpions</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Colby Sain</h3>
              <p className="text-base mb-1">Ecology, Evolution and Behavior Program, City College, City University of New York</p>
              <p className="text-meta mb-3">Graduate student from 2023 - M.S. on systematics and biogeography of montane lineages of vaejovid scorpions in the U.S.</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Nicolas Cazzaniga</h3>
              <p className="text-base mb-1">Ecology, Evolution and Behavior Program, City University of New York</p>
              <p className="text-meta mb-3">Graduate student from 2022 - Ph.D. on systematics, evolution and biogeography of the Neotropical whip spider family Phrynidae</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Javier Blasco Aróstegui</h3>
              <p className="text-base mb-1">Center of Ecology, Evolution and Climate Change, University of Lisbon, Portugal</p>
              <p className="text-meta mb-3">Graduate student from 2021 to 2026 - Ph.D. on systematics, evolution and biogeography of European scorpions</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Nayeli Gutiérrez Trejo</h3>
              <p className="text-base mb-1">Comparative Biology Ph.D. Program, Richard Gilder Graduate School, AMNH</p>
              <p className="text-meta mb-3">Graduate student from 2018 to 2023</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Jayson Slovak</h3>
              <p className="text-base mb-1">City University of New York</p>
              <p className="text-meta mb-3">Graduate student from 2016 to 2020</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              ...
              <p className="text-base mb-1">Richard Gilder Graduate School, American Museum of Natural History</p>
              <p className="text-meta mb-3">Graduate student from 2011 to 2016</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Tharina Bird</h3>
              <p className="text-base mb-1">Colorado State University, Fort Collins, CO | NSF BS&I Grant</p>
              <p className="text-meta mb-3">Graduate student from 2009 to 2014</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Lionel Monod</h3>
              <p className="text-base mb-1">CUNY, The City College of New York | AMNH Graduate Student Fellowship</p>
              <p className="text-meta mb-3">Graduate student from 2005 to 2011</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Edmundo González Santillan</h3>
              <p className="text-base mb-1">CUNY, The City College of New York | NSF REVSYS Grant</p>
              <p className="text-meta mb-3">Graduate student from 2004 to 2012</p>
              <p>
          ...
          <PeopleCard containerClassName="mb-8 pb-8">
            ...
            <PeopleCardBody>
              <h3 className="font-bold mb-1">Lauren A. Esposito</h3>
              <p className="text-base mb-1">CUNY, The City College of New York | MAGNET-STEM Fellowship | NSF AGEP Fellowship | CUNY College NOW Fellow | CUNY Magnet Dissertation Fellowship | NSF GK-12 Fellowship</p>
              <p className="text-meta mb-3">Graduate student from 2004 to 2011</p>
              <p>
