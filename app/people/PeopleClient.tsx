...
export function PeopleClient({ labHistorySections }: PeopleClientProps) {
  const {
    activeSection,
    contentRef,
    filteredResults,
        ...
        <div>
          ...
          <div className="space-y-6">
            {[
              ...
              { name: 'Maggie Ruben', affiliation: 'Sapienza University of Rome, Italy', years: '2018', image: 'people/Maggie-Ruben.jpg', bio: 'Maggie spent the summer of 2016 studying cuticular fluorescence in scorpions and other chelicerates including horseshoe crabs, solifuges, opilionids, and extinct eurypterids.' },
