  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="container mx-auto max-w-5xl px-6 py-12">
        ...
        <h2 className="font-bold mb-6">Research Laboratory Facilities</h2>
        
        <h3 className="font-bold mb-4">Natural Sciences Building Optical Equipment</h3>
        <p className="mb-6">
        ...
        <h3 className="font-bold mb-4">Molecular Systematics Laboratory</h3>
        <p className="mb-6">
        ...
        <p className="mb-6">
          The staff of the Division of Invertebrate Zoology includes <a href="/people/staff" className="text-color-link hover:text-color-link-hover underline">Steve Thurston,</a> a scientific illustrator, proficient in graphical software techniques as well as traditional scientific illustration.
        </p>
        <Image
