    ...
    <div className="bg-white min-h-screen">
      <div className="container mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Ecology</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Life History</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Conservation</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Dwindling Expertise</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Model System</h2>
            <p className="text-lg leading-8 text-gray-700 mb-6">
